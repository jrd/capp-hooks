...
These scripts will be executed while deploying/undeploying an application using [capp](https://github.com/jrd/capp) infrastructure.
...
The monitoring hooks allows an automatic configuration of monitoring dashboards.
...
* `templates` directory: json templates for the dashboards, that will be adapted to the service and environment and injected in Grafana, for the monitoring solution,
